...
/// </summary>
public static class Option_BindExtensions
{
    /// <summary>
    ...
    /// <param name="bindFunc">The func to apply if <paramref name="input"/> is in the Some state.</param>
    ...
    public static Option<TOutput> Bind<TInput, TOutput>(
        ...
        Func<TInput, Option<TOutput>> bindFunc)
    {
        return input.Match(
            some: value => bindFunc(value),
