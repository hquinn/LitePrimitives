...
public readonly struct Either<TFirst, TSecond, TLast>
{
    ...
    /// <summary>
    ///     Returns true if the <see cref="Either{TFirst, TSecond, TLast}"/> is in the First state.
    /// </summary>
    public bool IsFirst => _state == EitherState.First;

    /// <summary>
    ///     Returns true if the <see cref="Either{TFirst, TSecond, TLast}"/> is in the Second state.
    /// </summary>
    public bool IsSecond => _state == EitherState.Second;

    /// <summary>
    ///     Returns true if the <see cref="Either{TFirst, TSecond, TLast}"/> is in the Last state.
    /// </summary>
    ...
    public Either<TFirst, TSecond, TLast> Perform(
    ...
    /// <returns>The current object after possibly performing the action.</returns>
    public async Task<Either<TFirst, TSecond, TLast>> PerformAsync(
    ...
    /// <summary>
    ///      Implicitly constructs <see cref="Either{TFirst, TSecond, TLast}"/> from a <typeparamref name="TFirst"/> in the First state.
    /// </summary>
    /// <param name="first">The value to construct the <see cref="Either{TFirst, TSecond, TLast}"/> type from.</param>
    /// <returns>The <see cref="Either{TFirst, TSecond, TLast}"/> type in the First state.</returns>
    public static implicit operator Either<TFirst, TSecond, TLast>(TFirst first) => First(first);

    /// <summary>
    ///      Implicitly constructs <see cref="Either{TFirst, TSecond, TLast}"/> from a <typeparamref name="TSecond"/> in the Second state.
    /// </summary>
    /// <param name="second">The value to construct the <see cref="Either{TFirst, TSecond, TLast}"/> type from.</param>
    /// <returns>The <see cref="Either{TFirst, TSecond, TLast}"/> type in the Second state.</returns>
    public static implicit operator Either<TFirst, TSecond, TLast>(TSecond second) => Second(second);

    /// <summary>
    ///      Implicitly constructs <see cref="Either{TFirst, TSecond, TLast}"/> from a <typeparamref name="TLast"/> in the Last state.
    /// </summary>
    /// <param name="last">The value to construct the <see cref="Either{TFirst, TSecond, TLast}"/> type from.</param>
    /// <returns>The <see cref="Either{TFirst, TSecond, TLast}"/> type in the Last state.</returns>
    public static implicit operator Either<TFirst, TSecond, TLast>(TLast last) => Last(last);
}