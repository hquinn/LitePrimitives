...
public readonly struct Either<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TLast>
{
    ...
    /// <summary>
    ///     Returns true if the <see cref="Either{TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TLast}"/> is in the First state.
    /// </summary>
    public bool IsFirst => _state == EitherState.First;

    /// <summary>
    ///     Returns true if the <see cref="Either{TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TLast}"/> is in the Second state.
    /// </summary>
    public bool IsSecond => _state == EitherState.Second;

    /// <summary>
    ///     Returns true if the <see cref="Either{TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TLast}"/> is in the Third state.
    /// </summary>
    public bool IsThird => _state == EitherState.Third;

    /// <summary>
    ///     Returns true if the <see cref="Either{TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TLast}"/> is in the Fourth state.
    /// </summary>
    public bool IsFourth => _state == EitherState.Fourth;

    /// <summary>
    ///     Returns true if the <see cref="Either{TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TLast}"/> is in the Fifth state.
    /// </summary>
    public bool IsFifth => _state == EitherState.Fifth;

    /// <summary>
    ///     Returns true if the <see cref="Either{TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TLast}"/> is in the Sixth state.
    /// </summary>
    public bool IsSixth => _state == EitherState.Sixth;

    /// <summary>
    ///     Returns true if the <see cref="Either{TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TLast}"/> is in the Seventh state.
    /// </summary>
    public bool IsSeventh => _state == EitherState.Seventh;

    /// <summary>
    ///     Returns true if the <see cref="Either{TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TLast}"/> is in the Last state.
    /// </summary>
    ...
    public Either<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TLast> Perform(
    ...
    /// <returns>The current object after possibly performing the action.</returns>
    public async Task<Either<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TLast>> PerformAsync(
